...
class GigaChatModel(LangchainModel):
    ...
    def __init__(self, model: str = "GigaChat", batch_size: int = 1, scope: str = os.getenv("GIGACHAT_API_SCOPE"), credentials: str=os.getenv("GIGACHAT_CREDENTIALS"), verify_ssl_certs: bool = False, max_retries: int = 3, **kwargs):
        """
